...
const DropDownLink = ({ dropDownLinks, dropDownName = "more" }) => {
	...
	return (
		...
		>
			...
			/>
			{isDropDownOpen && (
				<div className="absolute top-[calc(100%-1px)] right-0 z-10 min-w-48 h-fit rounded-md pb-1 [&>*:not(:last-child)]:border-b-[2px] border border-tertiary border-solid border-t-0 bg-primary border-b-2">
					{createNavLink(
						dropDownLinks,
